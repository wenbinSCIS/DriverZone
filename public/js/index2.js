        ...
        for (let ele in input) {
            ...
            <div class="block-3 bo2">
                <div class="wrap-pic-b3 wrap-pic-w hov5 bo2-b">
                    <a href="../html/course-detail.html?id=${name}"><img src="${image}" width="240px" height="276px" alt="IMG-COURSE"></a>
                </div>
                ...
                <div class="wrap-text-b3 p-l-20 p-r-20 p-t-16 p-b-26">
                    ...
                    <a href="../html/course-detail.html"><h4 class="m-txt8 hov-color-main trans-04 p-b-12">
                    ...
                    <div class="wrap-btn-b3 flex-w p-t-13">
                        ...
                        <div class="p-t-8">
                            <!-- Button -->
                            <a href="../html/course-detail.html?id=${name}" class="btn-drive m-txt10 size4 bo3 bg1 hov-color-white bo-rad-4">
                                Detail
                            </a>
                        </div>
                    </div>
